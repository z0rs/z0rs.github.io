...
tags: [DEFCON CTF, mathwhiz]
date: 2015-05-23
author: Eno
featuredImage: https://cdn.tresorit.com/blog/ghost-media/2015/06/Road-to-Vegas_Defcon_Tresorit-hackers_capture-the-flag.png
---
...
The challenge's pretty simple. The service will ask you a bunch of math problems(**1000 actually**), all you need to do
is to answer all of them and you'll get the flag. Notice that some of the questions contains some tricky input, like
**"ONE + TWO : ?"**, **"[1 + 2] + 4=?"**......etc.
