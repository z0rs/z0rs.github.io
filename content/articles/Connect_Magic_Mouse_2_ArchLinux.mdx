...
So, you got yourself a **Magic Mouse 2** and you're running **Arch Linux**? Good luck, buddy. Unlike macOS, this ain't
plug-and-play. But no worries, I got you covered. Let's get that slick Apple mouse working properly.
...
That’s it, folks! Now you can enjoy using your **Magic Mouse 2 on Arch Linux** without going insane. If something breaks
(because it’s Linux, duh), drop into **bluetoothctl** and reconnect manually.
