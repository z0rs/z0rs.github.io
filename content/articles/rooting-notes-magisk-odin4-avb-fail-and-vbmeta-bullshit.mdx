...
```txt
Samsung got pissed at custom VBMETA,
so we shoved stock VBMETA back in its face
while keeping the Magisk-patched AP setup alive.
```
...
Very Samsung. Very bullshit. Very educational.